...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1200" height="675" viewBox="0 0 1200 675">
  ...
  <g transform="translate(58 70)">
    ...
    <text x="32" y="273" font-family="DejaVu Sans, Noto Sans, sans-serif" font-size="21" font-weight="700" fill="#ffffff">Larger album artwork</text>
    <rect x="4" y="316" width="350" height="54" rx="27" fill="#7738ff"/>
    <text x="32" y="351" font-family="DejaVu Sans, Noto Sans, sans-serif" font-size="21" font-weight="700" fill="#ffffff">Contextual search</text>
    <rect x="4" y="394" width="350" height="54" rx="27" fill="#101b35"/>
    <text x="32" y="429" font-family="DejaVu Sans, Noto Sans, sans-serif" font-size="21" font-weight="700" fill="#ffffff">Adaptive player</text>
  </g>
